...
return [
    ...
    'rate_mentee_permission' => 'Δε σας επιτρέπεται να βαθμολογήσετε το mentee για αυτή τη συνεδρία.',
    'rate_mentee' => 'Βαθμολογήστε το mentee σας',
    'invalid_operation' => 'Μη έγκυρη λειτουργία.',
    'rate_mentee_more_than_once' => 'Δεν μπορείτε να βαθμολογήσετε το mentee παραπάνω από μία φορές για μια συνεδρία.',
    ...
    'rate_mentor_permission' => 'Δε σας επιτρέπεται να βαθμολογήσετε το μέντορά σας για αυτή τη συνεδρία.',
    'rate_mentor' => 'Βαθμολογήστε το μέντορά σας',
    'rate_mentor_more_than_once' => 'Δεν μπορείτε να βαθμολογήσετε το μέντορά σας παραπάνω από μία φορές για μια συνεδρία.',
    'rate_mentor_permission_denied' => 'Οι άδειες απορρίφθηκαν. Δεν μπορείτε να βαθμολογήσετε το μέντορα.',
    'your_session_with' => 'Η συνεδρία σας με',
