...
return [
    ...
    'career_goals.required' => 'Οι στόχοι είναι υποχρεωτικό πεδίο',
    'specialty.required' => 'Η ειδικότητα είναι υποχρεωτικό πεδίο',
    'rating.required' => 'Η βαθμολόγηση είναι υποχρεωτική',
    'rating.error' => 'Παρακαλώ βαθμολογήστε κάνοντας κλικ σε ένα αστέρι',
    ...
    'rate_mentee_permission' => 'Δε σας επιτρέπεται να βαθμολογήσετε το mentee για αυτό το mentoring πρόγραμμα.',
    'rate_mentee' => 'Βαθμολογήστε το mentee σας',
    'invalid_operation' => 'Μη έγκυρη λειτουργία.',
    'rate_mentee_more_than_once' => 'Δεν μπορείτε να βαθμολογήσετε το mentee παραπάνω από μία φορές για ένα mentoring πρόγραμμα.',
    'thank_you_for_rating' => 'Ευχαριστούμε για τη βαθμολογία σας!',
    'rate_mentee_permission_denied' => 'Οι άδειες απορρίφθηκαν. Δεν μπορείτε να βαθμολογήσετε το mentee.',
    'rate_mentor_permission' => 'Δε σας επιτρέπεται να βαθμολογήσετε το μέντορά σας για αυτό το mentoring πρόγραμμα.',
    'rate_mentor' => 'Βαθμολογήστε το μέντορά σας',
    'rate_mentor_more_than_once' => 'Δεν μπορείτε να βαθμολογήσετε το μέντορά σας παραπάνω από μία φορές για ένα mentoring πρόγραμμα.',
    'rate_mentor_permission_denied' => 'Οι άδειες απορρίφθηκαν. Δεν μπορείτε να βαθμολογήσετε το μέντορα.',
    'your_session_with' => 'Το mentoring πρόγραμμα σας με',
    'completed_session_rating' => 'έχει ολοκληρωθεί. Παρακάτω, μπορείτε να βαθμολογήσετε το',
    'yours' => 'σας',
    'general_experience_rating' => 'Πώς βαθμολογείτε συνολικά την εμπειρία σας;<br>Θα ήταν χαρά μας να έχουμε αναλυτική αξιολόγηση των συναντήσεων σας, πατώντας',
    'here' => 'εδώ',
    'rating_comments_placeholder' => 'Μπορείτε να προσθέσετε σχόλια στη βαθμολογία σας',
    'rate' => 'Βαθμολογήστε',
    'response_to_session_invitation' => 'Απάντηση σε πρόσκληση για mentoring',
    'invitation_accepted' => 'Έχετε επιτυχώς αποδεχτεί την πρόσκληση σε mentoring πρόγραμμα',
    'invitation_declined' => 'Έχετε επιτυχώς απορρίψει την πρόσκληση σε mentoring πρόγραμμα',
