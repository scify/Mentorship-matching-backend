        ...
        @if($loggedInUser != null)
            @if($loggedInUser->userHasAccessToCRUDSystemUsers())
                @if(isset($accountManagersActiveSessions[$user->id]))
                    <p>Remaining capacity: {{ $accountManagersActiveSessions[$user->id]->remainingCapacity }}</p>
                @endif
                ...
                <div class="layered-content bg-orange">
                    <div class="overflow-content">
                        <ul class="borderless float-left">
                            ...
                            <li><a href="{{route('showEditUserForm', $user->id)}}" target="_blank" class="btn btn-flat btn-ripple"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a></li>
                            <li>
                                <a data-toggle="modal"
