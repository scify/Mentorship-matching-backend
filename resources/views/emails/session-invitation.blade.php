...
@section('email-body')
    ...
    <div style="display: table; width: 100%">
        ...
        <p style="text-align: center; display: table-cell; width: 50%;">
            <a href="{{ route('declineToManageMentorshipSession', ['id' => $id, 'email' => $email, 'mentorshipSessionId' => $mentorshipSessionId]) }}" style="display: block; background-color: #d9534f; color: white; padding: 10px; width: 150px; text-decoration: none; margin-left: auto; margin-right: auto;">
                Decline
            </a>
        </p>
    </div>
