                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="formRow row">
                                <!-- First name-->
                                <div class="col-md-3 formElementName">{{trans('messages.first_name')}}</div>
                                <div class="col-md-9">
                            ...
                            <div class="formRow row">
                                <!-- Last name-->
                                <div class="col-md-3 formElementName">{{trans('messages.last_name')}}</div>
                                <div class="col-md-9">
                            ...
                            <div class="formRow row">
                                <!-- Residence area -->
                                <div class="col-md-3 formElementName">{{trans('messages.residence')}}</div><!--.col-md-3-->
                                <div class="col-md-9">
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- Is employed -->
                            <div class="formRow row">
                                <div class="col-md-3 formElementName">{{trans('messages.are_you_employed')}}</div><!--.col-md-3-->
                                <div class="col-md-9">
                                    <div class="switcher">
                            ...
                            <div class="formRow row">
                                <!-- Job Description -->
                                <div class="col-md-3 formElementName">{{trans('messages.job_description_form')}}</div>
                                <div class="col-md-9">
                            ...
                            <div class="formRow row margin-top-40">
                                ...
                                <div class="col-md-3 formElementName">{{trans('messages.specialty_experience_form')}}</div>
                                <div class="col-md-9">
                            ...
                            <div class="formRow row margin-top-40">
                                <!-- Expectations -->
                                <div class="col-md-3 formElementName">{{trans('messages.expectations_form')}}</div>
                                <div class="col-md-9">
                                    <div class="{{ $errors->first('expectations')?'has-error has-feedback':'' }}">
                                        <div class="inputer">
                                            <div class="input-wrapper">
                                                <textarea required class="form-control" name="expectations" placeholder="{{trans('messages.expectations_form_placeholder')}}">{{ old('expectations') != '' ? old('expectations') : $mentee['expectations']}}</textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="formRow row margin-top-40">
                                <!-- Career goals -->
                                <div class="col-md-3 formElementName">{{trans('messages.career_goals_form')}}</div>
                                <div class="col-md-9">
                                    <div class="{{ $errors->first('career_goals')?'has-error has-feedback':'' }}">
                                        <div class="inputer">
                                            <div class="input-wrapper">
                                                <textarea required class="form-control" name="career_goals">{{ old('career_goals') != '' ? old('career_goals') : $mentee['career_goals']}}</textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="formRow row">
                                <!-- Reference -->
                                <div class="col-md-3 formElementName">{{trans('messages.reference_form')}}</div>
                                <div class="col-md-9">
                                    <div class="{{ $errors->first('reference')?'has-error has-feedback':'' }}">
                                        <div class="inputer">
                                            <div class="input-wrapper">
                                                <input placeholder="" type="text" class="form-control" name="reference"
