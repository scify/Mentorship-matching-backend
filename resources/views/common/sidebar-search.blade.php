                        ...
                        <li class="has-action-left">
                            ...
                            <a href="#" class="visible">
                                ...
                                <div class="list-content">
                                    <span class="title">Tasos Pagkakis</span>
                                    <span class="caption">Global PR Manager - Ericsson</span>
                                </div>
                            </a>
                        </li>
                        <li class="has-action-left">
                            ...
                            <a href="#" class="visible">
                                ...
                                <div class="list-content">
                                    <span class="title">Ioanna Vlahaki</span>
                                    <span class="caption">Human Resources Director - Diageo Hellas</span>
                                </div>
                            </a>
                        </li>
                        <li class="has-action-left">
                            ...
                            <a href="#" class="visible">
                                ...
                                <div class="list-content">
                                    <span class="title">Vassileios Velkos</span>
                                    <span class="caption">Career Services Manager - kariera.gr</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="result result-users">
                    ...
                    <ul class="list-material">
                        <li class="has-action-left">
                            ...
                            <a href="#" class="visible">
                                <div class="list-action-left">
                                    <img src="{{ asset("/assets/img/girl.png") }}" class="face-radius" alt="">
                                </div>
                                <div class="list-content">
                                    <span class="title">Maria Angelopoulou</span>
                                    <span class="caption">Platform Administrator</span>
                                </div>
                            </a>
                        </li>
                        <li class="has-action-left">
                        ...
                        <li class="has-action-left">
                            ...
                            <a href="#" class="visible">
                                ...
                                <div class="list-content">
                                    <span class="title">Paul Isaris</span>
                                    <span class="caption">Platform Administrator</span>
                                </div>
                            </a>
                        </li>
