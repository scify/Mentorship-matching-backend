                        ...
                        <div class="row">
                            <div class="col-md-12 padding-0">
                                <div class="row formRow">
                                    <div class="col-md-6">
                                        <!-- Residence Area -->
                                        <div class="margin-top-40 margin-bottom-5 selecterTitle">{{trans('messages.residence')}}</div>
                        ...
                        <div class="row">
                            <div class="col-md-12 padding-0">
                                <div class="row formRow">
                                    <div class="col-md-6">
                                        <!-- Specialty -->
                                        <div class="margin-top-40 margin-bottom-5 selecterTitle">{{trans('messages.specialty_form_description')}}</div>
                                    ...
                                    <div class="col-md-6">
                                        <!-- Industry -->
                                        <div class="margin-top-40 margin-bottom-5 selecterTitle">{{trans('messages.mentor_industry_form_description')}}</div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 padding-0">
                                        <div class="row formRow">
                                            <div class="col-md-6">
                                                <!-- Industry -->
                                                <div class="margin-top-40 margin-bottom-5 selecterTitle">{{trans('messages.company')}}</div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="margin-top-40 margin-bottom-5 selecterTitle">{{trans('messages.availability')}}</div>
                                                <div class="switcher">
                                ...
                                <div class="row formRow">
                                    <div class="col-md-6">
                                        ...
                                        <div class="{{ $errors->first('skills')?'has-error has-feedback':'' }}">
                                            <div class="inputer floating-label">
                                                <div class="input-wrapper">
                                                    <textarea class="form-control" name="skills" placeholder="{{trans('messages.skills.capitalAll')}}">{{ old('skills') != '' ? old('skills') : $mentor['skills']}}</textarea>
                                                </div>
                                            </div>
