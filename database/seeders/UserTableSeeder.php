...
class UserTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        DB::table('users')->insert(array(
            ...
            array('id' => 3, 'first_name' => 'Alex', 'last_name' => 'Tzoumas', 'state_id' => 1, 'email' => 'a.tzoumas@scify.org', 'password' => '$2y$10$AB2Q2QgPWuMXyVis.EgUau2F2TZK25lFe6SB/LyEMFzL38Qqjgy1e')
        ));
    }
}
